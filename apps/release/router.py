...
from .views import ReleaseViewset, CountChartsViewsetV2, CountUserCViewsetV2, PermNextViewset
...
release_router.register('permnext', PermNextViewset, base_name="permnext")
